...
$result_ajat = mysql_query("SELECT * FROM ajat,valinnat WHERE valinnat.kayttaja = '$kayt' AND ajat.kurssikoodi = valinnat.kurssikoodi AND ajat.alkuperiodi='1' AND valinnat.alkuperiodi='1' AND nimi NOT LIKE '%itseopiskelu%'");
