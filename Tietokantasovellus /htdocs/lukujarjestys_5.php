...
$result_ajat = mysql_query("SELECT * FROM ajat,valinnat WHERE kayttaja='$kayt' AND ajat.kurssikoodi = valinnat.kurssikoodi AND ajat.alkuperiodi='5' AND valinnat.alkuperiodi='5' AND nimi NOT LIKE '%itseopiskelu%'");
