...
$result_ajat = mysql_query("SELECT * FROM ajat,valinnat WHERE kayttaja='$kayt' AND ajat.kurssikoodi = valinnat.kurssikoodi AND ajat.loppuperiodi='6' AND valinnat.loppuperiodi='6' AND nimi NOT LIKE '%itseopiskelu%'");
